        ...
        <div class="columns">
          <div class="column is-narrow" style="width: 300px;">
            ...
            <div class="content is-small">
              ...
              <b-icon icon="map-marker" size="is-small"></b-icon>{{ $t('footer.location') }}<br>
              <a class="has-text-dark" href="mailto:hello@olivia-ai.org">
                <b-icon icon="email" size="is-small"></b-icon> hello@olivia-ai.org
              </a>
              <br>
              <br>
          ...
          <div class="column">
            <div class="columns">
              <div class="column">
                ...
                <ul>
                  <li>
                    <a class="has-text-dark" href="https://docs.olivia-ai.org">{{ $t('navbar.documentation') }}</a>
                  </li>
                  <li>
                    <a class="has-text-dark" href="/blog">{{ $t('navbar.blog') }}</a>
                  </li>
                  <li>
                    <a class="has-text-dark" href="/changelog">{{ $t('navbar.changelog') }}</a>
                  </li>
                  <li>
                    <a class="has-text-dark" href="mailto:hello@olivia-ai.org">{{ $t('footer.about.contact') }}</a>
                  </li>
                </ul>
              </div>
              <div class="column">
              ...
              <div class="column">
                ...
                <ul>
                  ...
                  <li><a rel="noopener noreferrer" target="_blank" class="has-text-dark" href="https://discord.gg/wXDwTdy">Discord</a></li>
                </ul>
              </div>
            </div>
          </div>
